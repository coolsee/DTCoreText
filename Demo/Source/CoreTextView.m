...
- (void)setAttributesStringAttributes:(NSMutableAttributedString *)attributedString
{
	...
	NSMutableDictionary *attributes = [[NSMutableDictionary alloc] initWithObjectsAndKeys:(__bridge id)font, kCTFontAttributeName, kernNum, kCTKernAttributeName, color.CGColor, kCTForegroundColorAttributeName, nil];
...
- (void)setAttributedStringParagraphStyle:(NSMutableAttributedString *)attributedString
{
	...
	NSDictionary *paragraphStyleDic = [[NSDictionary alloc] initWithObjectsAndKeys:(__bridge id)paragraphStyle, kCTParagraphStyleAttributeName, nil];
